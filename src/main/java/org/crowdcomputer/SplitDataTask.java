...
public class SplitDataTask implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		int n_value = Integer.parseInt(""+n.getExpressionText());
		int m_value = Integer.parseInt(""+m.getExpressionText());
		Object d = execution.getVariable("data");
		String data = (d==null) ? "[]" : (""+d) ;
		log.debug("data " + data);
		JSONObject results = croco.splitData(data, operation_value, n_value, m_value);
