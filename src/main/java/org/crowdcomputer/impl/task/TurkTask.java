...
public class TurkTask extends BaseTask {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		parameters.put("merge",Boolean.parseBoolean(merge.getExpressionText()));

		JSONObject ret_ctask = croco.createAMTTask(process, title, desc,
				deadline_date, n_o_i, url, rew, s_reward_strategy,
